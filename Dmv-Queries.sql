-- Occasionally I may update these queries or dd new ones.  For the latest version, 
--     this is the landing spot on the blog:
--
-- http://buildingbettersoftware.blogspot.com/search/label/DMVs
--
-- This links to all of the pages that actually have the queries
